...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactMotion = __webpack_require__(159);
	...
	var Menu = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return { open: false, options: ['kj', 'yahoo', 'react', 'node', 'server'], selected: 'kj' };
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        Motion,
	        { style: { x: spring(this.state.open ? 100 : 0) } },
	        function (_ref) {
	          var x = _ref.x;
	          return(
	            ...
	            React.createElement(
	              ...
	              _this.state.options.map(function (item, i) {
	                var angle = -45 + i * 35;
	                var xcode = x * Math.cos(angle / 180 * Math.PI);
	                var ycode = x * Math.sin(angle / 180 * Math.PI);
	                return React.createElement('div', { className: 'myItem', onClick: _this.itemClick.bind(null, item), style: {
	...
	var PlayListApp = React.createClass({
	  ...
	  handleClick: function handleClick() {
	    this.setState({ name: "clickName" });
	  },

	  render: function render() {
	    console.log("rendering...");
	    var options = ["volvo", "saab"];
	    return React.createElement(
	      'div',
	      null,
	...
	if (isNode) {
	  ...
	  module.exports.PlayListApp = PlayListApp;
	}

	if (typeof document !== 'undefined') {
	  console.log("Now we are in the browser side and start the client render. React won't render an exisiting element rendered by server.");
	  ReactDOM.render(React.createElement(PlayListApp, { name: 'KJ' }), document.querySelector('#react-root'));
	}
